# Zoe is amazing — Animated Console Banner

Small Python script that prints "Zoe is amazing" in large ASCII art with cycling colors and optional flashing.
...
Options
- `--count N` number of frames (default 40)
